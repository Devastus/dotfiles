...
lf.setup({
  ...
  views = { -- window dimensions to rotate through
    ...
    {
      width = 1.0 * fn.float2nr(fn.round(0.7 * vim.o.columns)) / vim.o.columns,
      height = 1.0 * fn.float2nr(fn.round(0.7 * vim.o.lines)) / vim.o.lines,
    },
...
nmap("<leader>f",  "<cmd>lua require('lf').start()<CR>")
